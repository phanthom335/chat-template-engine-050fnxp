    """
    Chat Template Engine 050fnxp
    ============================
    Open-source NLP tool built to analyse text data with state-of-the-art techniques.
    ...
    APP_NAME    = "Chat Template Engine 050fnxp"
    APP_VERSION = "1.0.0"
...
return result
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source NLP tool built to analyse text data with state-of-the-art techniques.")
